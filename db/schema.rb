...
ActiveRecord::Schema.define(version: 2020_03_26_153002) do

  create_table "status_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "status"
